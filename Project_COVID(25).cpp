...
void edit_profile(char name[],char mail[],char pass[]);
...
void hospital_update()//update
{
    struct COVID h[500];
    int i=0;
    char Delete_name[50],Update_name[50];
    bool r;
...
void doctors_update()//update
{
    struct COVID d[500];
    int i=0;
    char Delete_name[50],Updte_name[50];
    bool r;
    FILE *hptl;
...
void location_update()//update
{
    ...
    struct COVID l[500];
    int i=0;
    char Delete_name[50],Update_loc[50];
    bool r;
    FILE *hptl;
...
void number_update()//update
{
    ...
    int i=0;
    char Delete_name[50],new_num[50];
    bool r;
    FILE *hptl;
...
void first_aid_info_update()//update
{
    ...
    int i=0;
    char Delete_name[50],new_line[50];
    bool r;
    FILE *hptl;
...
void medicine_update()//update
{
    ...
    int i=0;
    char Delete_name[50],new_medicine[50];
    bool r;
    FILE *hptl;
    hptl=fopen("medicine.txt","r");
    if(hptl==NULL)
...
void Online_payment_method_for_user_update()//update
{
    ...
    int i=0;
    char Delete_name[50],new_payment[50];
    bool r;
    FILE *hptl;
