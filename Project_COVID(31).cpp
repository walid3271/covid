...
void test()
{
    ...
    else
    {
        while(!feof(hptl))
        {
            fscanf(hptl, "%s %s %s",&f1[i].src,&f2[i].src,&f3[i].src);
            cout<< "                                        " <<f2[i].src<<endl;
            i++;
        }
    }
    ...
    for (int k = 0; k <= i; k++)
    {
        ...
        if ( r==0 )
        {
            cout<< "                                        User Data Exist." <<endl;
            cout<< "                                        Name : " << f1[k].src<<endl;
            cout<< "                                        Mail : "<<f2[k].src<<endl;
            cout<< "                                        Password : " <<f3[k].src<<endl;
            break;
        }
    }
    ...
    /*
        ...
        for(int k=0; k<i-1; k++)
        {
            ...
            {
                temp=f3[k].sr;
                f3[k].sr=f3[Min_index].sr;
                f3[Min_index].sr=temp;
            }
        }

        int Bigen,End,Midle,target;
        cout<< "                                        Your searching data ? ";
        cin>>target;
        Bigen=0,End=i;
        while(Bigen<=End)
        {
            Midle=(Bigen+End)/2;
            if(f3[Midle].sr==target)
            {
                cout<< "                                        User Data Exist." <<endl;
                //cout<< "                                        Name : " << f1[Midle].src<<endl;
                //cout<< "                                        Mail : "<<f2[Midle].src<<endl;
                //cout<< "                                        Password : " <<f3[Midle].sr<<endl;
                break;
            }
            if(f3[Midle].sr<target)
            {
