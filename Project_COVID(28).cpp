...
{
    //admin//
    char h_n[500];//hospital_name
    char d_n[500];//doctor_name
    char l_n[500];//location_name
...
void edit_profile(char name[],char mail[],char pass[])
{
    ...
    int i=0;
    char edit_name[500],edit_mail[500],edit_pass[500];
    bool r1,r2,r3;
    FILE *hptl;
...
void user_panel_login()
{
    ...
    while(1)
    {
        ...
        FILE *hptl;
        char name[100],name2[100],mail[100],pass[100],pass2[100];
        bool r1,r2,r3;
        int k=1;
        hptl=fopen("registration_for_user.txt","r");
        if(hptl==NULL)
